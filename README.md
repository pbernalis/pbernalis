...
- [Simple ASP.NET Web API](https://github.com/pbernalis/SimpleWebAPI/blob/main/README.md): A simple ASP.NET Web API project demonstrating user authentication and logging functionalities with OWIN, Entity Framework, and Log4Net.
