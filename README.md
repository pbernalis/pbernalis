...
- Developed and maintained enterprise applications using Oracle Application Express, C#, .NET Core, and SQL Server.
- Implemented AI and machine learning models for customer service solutions.
